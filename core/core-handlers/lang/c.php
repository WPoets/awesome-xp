...
function even($atts,$content=null,$shortcode = array()){
...
function eq($atts,$content=null,$shortcode = array()){
...
function neq($atts,$content=null,$shortcode = array()){
	$cond = \aw2_library::resolve_chain($atts['cond']);
...
function gt($atts,$content=null,$shortcode = array()){
	$cond = \aw2_library::resolve_chain($atts['cond']);
...
function lt($atts,$content=null,$shortcode = array()){
	$cond = \aw2_library::resolve_chain($atts['cond']);
...
function gte($atts,$content=null,$shortcode = array()){
	$cond = \aw2_library::resolve_chain($atts['cond']);
...
function lte($atts,$content=null,$shortcode = array()){
	$cond = \aw2_library::resolve_chain($atts['cond']);
...
function _true($atts,$content=null,$shortcode = array()){
...
function _false($atts,$content=null,$shortcode = array()){
...
function yes($atts,$content=null,$shortcode = array()){
...
function no($atts,$content=null,$shortcode = array()){
...
function not_arr($atts,$content=null,$shortcode = array()){
...
function not_str($atts,$content=null,$shortcode = array()){
...
function _bool($atts,$content=null,$shortcode = array()){
...
function not_bool($atts,$content=null,$shortcode = array()){
...
function not_num($atts,$content=null,$shortcode = array()){
...
function not_int($atts,$content=null,$shortcode = array()){
...
function date_obj($atts,$content=null,$shortcode = array()){
...
function not_date_obj($atts,$content=null,$shortcode = array()){
...
function obj($atts,$content=null,$shortcode = array()){
...
function not_obj($atts,$content=null,$shortcode = array()){
...
function zero($atts,$content=null,$shortcode = array()){
...
function positive($atts,$content=null,$shortcode = array()){
...
function negative($atts,$content=null,$shortcode = array()){
...
function ws($atts,$content=null,$shortcode = array()){
...
function not_ws($atts,$content=null,$shortcode = array()){
...
function not_empty($atts,$content=null,$shortcode = array()){
...
function not_blank($atts,$content=null,$shortcode = array()){
...
function is_blank($atts,$content=null,$shortcode = array()){
...
function _null($atts,$content=null,$shortcode = array()){
...
function not_null($atts,$content=null,$shortcode = array()){
...
function request_exists($atts,$content=null,$shortcode = array()){
...
function request_not_exists($atts,$content=null,$shortcode = array()){
...
function aw2_error($atts,$content=null,$shortcode = array()){
...
function not_exists($atts,$content=null,$shortcode = array()){
...
function user_can($atts,$content=null,$shortcode = array()){
...
function user_cannot($atts,$content=null,$shortcode = array()){
...
function logged_in($atts,$content=null,$shortcode = array()){
...
function not_logged_in($atts,$content=null,$shortcode = array()){
	if(is_user_logged_in())
		return false;
}
